...
![](Figures/Chapter%2011/political%20unit.png){width="50%"}
...
For a geographic SRS, the coordinates are latitude and longitude. The SRID is 4326. [^311-spatial-1]

[^311-spatial-1]: epsg.io/4326
...
![](Figures/Chapter%2011/Ireland%20grid.png){width="75%"}
...
```{sql, connection = db, eval = FALSE}
INSERT INTO political_unit VALUES 
('Republic of Ireland','ie', 3.9);
INSERT INTO political_unit VALUES 
('Northern Ireland','ni', 1.7);
INSERT INTO boundary VALUES
	(1,ST_GeomFROMText('POLYGON((9 8, 9 3, 4 1, 2 2, 1 3, 
	3 5, 3 6, 2 6,2 9, 5 9, 5 10, 6 11, 7 11, 7 10, 6 9,
	7 8, 7 9, 8 9, 8 8, 9 8))', 0),'ie');
INSERT INTO boundary VALUES
	(2,ST_GeomFROMText('POLYGON((7 11, 9 11, 10 9, 10 8, 
	8 8, 8 9, 7 9,7 8, 6 9, 7 10, 7 11))', 0),'ni');
INSERT INTO city VALUES 
 ('Dublin',ST_GeomFROMText('POINT(9 6)', 0),'ie');
INSERT INTO city VALUES 
 ('Cork',ST_GeomFROMText('POINT(5 2)', 0),'ie');
INSERT INTO city VALUES 
 ('Limerick',ST_GeomFROMText('POINT(4 4)', 0),'ie');
INSERT INTO city VALUES 
 ('Galway',ST_GeomFROMText('POINT(4 6)', 0),'ie');
INSERT INTO city VALUES 
 ('Sligo',ST_GeomFROMText('POINT(5 8)', 0),'ie');
INSERT INTO city VALUES 
 ('Tipperary',ST_GeomFROMText('POINT(5 3)', 0),'ie');
INSERT INTO city VALUES 
 ('Belfast',ST_GeomFROMText('POINT(9 9)', 0),'ni');
INSERT INTO city VALUES 
 ('Londonderry',ST_GeomFROMText('POINT(7 10)', 0),'ni');
```
...
![](Figures/Chapter%2011/boundary.png){width="100%"}
...
WHERE NOT EXISTS
	(SELECT * FROM  other WHERE ST_X(other.cityloc) 
	  < ST_X(west.cityloc));
```
...
```{sql, connection = db, eval = FALSE}
GEOMETRYCOLLECTION(LINESTRING(15 15, 20 20), 
...
![](Figures/Chapter%2011/r-tree.png){width="75%"}
...
![](Figures/Chapter%2011/searching-r-tree.png){width="75%"}
...
*Types of temporal data*[^311-spatial-2]

[^311-spatial-2]: Adapted from: Goralwalla, I. A., M. T. Özsu, and D. Szafron. 1998. *An object-oriented framework for temporal data models. In Temporal databases: research and practice*, edited by O. Etzion, S. Jajoda, and S. Sripada. Berlin: Springer-Verlag

![](Figures/Chapter%2011/temporal%20data.png){width="50%"}
...
[^311-spatial-3]: Rotates in the opposite direction to the other planets

To insert the values for Mercury, you would use

```{sql, connection = db, eval = FALSE}
INSERT INTO planet VALUES 
 ('Mercury','1407.51 hours','0.24 years');
```
...
![](Figures/Chapter%2011/nation-stock%20temporal.png){width="75%"}
...
![](Figures/Chapter%2011/Iberia-grid.png){width="75%"}
