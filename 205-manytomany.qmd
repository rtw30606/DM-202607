...
![](Figures/Chapter%205/m-m-wb.png){width="75%"}
...
![](Figures/Chapter%205/sale-item-wb.png){width="75%"}
...
>
> Two girls named Sarah Lee Ferguson were born on May 3, 1959. The U.S. government considered them one and the same and issued both the same Social Security number (SSN), a nine-digit identifier of U.S. residents. Now Sarah Lee Ferguson Boles and Sarah Lee Ferguson Johnson share the same SSN.[^205-manytomany-1]
>
...
[^205-manytomany-1]: "Two women share a name, birthday, and S.S. number!" Athens Daily News, January 29 1990, 7A. Also, see <https://www.computerworld.com/article/3004659/a-tale-of-two-women-same-birthday-same-social-security-number-same-big-data-mess.html>
...
![](Figures/Chapter%205/divide%20template.png){width="75%"}
...
This query uses the same two tables as the previous query. In this case, INTERSECT (i.e., and) then combines the results of the tables including ***only*** rows in both tables and excluding duplicates.[^205-manytomany-2]

[^205-manytomany-2]: MySQL does not support INTERSECT. Use another AND in the WHERE statement.
...
![](Figures/Chapter%205/golf.png){width="75%"}
...
7.  Answer the following queries based on the described relational database.
    ...
    ![](Figures/Chapter%205/gift.png){width="75%"}
