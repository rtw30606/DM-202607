...
![](Figures/Chapter%206/org%20chart.png){width="65%"}
...
![](Figures/Chapter%206/1-and-1.png){width="50%"}

*MySQL Workbench version of a 1:m and 1:1 relationship*

![](Figures/Chapter%206/1-1-wb.png){width="75%"}
...
![](Figures/Chapter%206/recursive-1-and-m.png){width="75%"}

*MySQL Workbench version of a recursive 1:m relationship*

![](Figures/Chapter%206/recursive-1-and-m-wb.png){width="75%"}
...
![](Figures/Chapter%206/recursive-1-and-1.png){width="35%"}

*MySQL Workbench version of a recursive 1:1 relationship*

![](Figures/Chapter%206/recursive-1-and-1-wb.png){width="40%"}
...
INSERT INTO monarch VALUES 
  ('Queen','Victoria','I','1837-06-20','William','IV');
INSERT INTO monarch VALUES 
  ('King','Edward','VII','1901-01-22','Victoria','I');
INSERT INTO monarch VALUES 
  ('King','George','V','1910-05-06','Edward','VII');
INSERT INTO monarch 
 VALUES 
  ('King','Edward','VIII','1936-01-20','George','V');
INSERT INTO monarch VALUES 
  ('King','George','VI','1936-12-11','Edward','VIII');
INSERT INTO monarch VALUES 
 ('Queen','Elizabeth','II','1952-02-06','George','VI');
...
![](Figures/Chapter%206/recursive-m-and-m.png){width="50%"}

*MySQL Workbench version of a recursive m:m relationship*

![](Figures/Chapter%206/recursive-m-and-m-wb.png){width="50%"}
...
CREATE TABLE assembly (
 ...
 PRIMARY KEY(prodid, subprodid),
	CONSTRAINT fk_assembly_product 
	 FOREIGN KEY(prodid)
	  REFERENCES product(prodid),
	CONSTRAINT fk_assembly_subproduct 
	 FOREIGN KEY(subprodid)
		REFERENCES product(prodid));
```
