...
![](Figures/Chapter%204/nation-stock.png){width="50%"}

Because the meaning of relationships frequently can be inferred, there is no need to label every one; however, each additional relationship between two entities should be labeled to clarify meaning. Also, it is a good idea to label one-to-one (1:1) relationships, because the meaning of the relationship is not always obvious.
...
![](Figures/Chapter%207/relationship%20labeling.png){width="50%"}
...
![](Figures/Chapter%205/sale-item.png){width="75%"}
...
![](Figures/Chapter%207/revised%20NATION-STOCK.png){width="75%"}
...
![](Figures/Chapter%207/geography.png){width="75%"}

Before looking more closely at the data model, let's clarify the meaning of *unittype*. Because most countries are divided into administrative units that are variously called states, provinces, territories, and so forth, *unittype* indicates the type of administrative unit (e.g., state).
...
![](Figures/Chapter%207/geography%20revised.png){width="75%"}
...
![](Figures/Chapter%207/marriage-1.png){width="75%"}
...
![](Figures/Chapter%207/marriage-4.png){width="50%"}
...
![](Figures/Chapter%207/marriage-5.png){width="50%"}
...
![](Figures/Chapter%207/library-1.png){width="50%"}
...
![](Figures/Chapter%207/library-2.png){width="75%"}
...
![](Figures/Chapter%207/history-1.png){width="75%"}
...
![](Figures/Chapter%207/history-2.png){width="100%"}
...
![](Figures/Chapter%207/history-3.png){width="100%"}
...
![](Figures/Chapter%207/history-4.png){width="100%"}
...
![](Figures/Chapter%207/airline.png){width="75%"}

The problem with three separate m:m relationships is that it is unclear where to store data about the lease. Is it stored in AIRLINE-AIRCRAFT? If you store the information there, what do you do about recording the agent who closed the deal? After you read the fine print and do some more thinking, you discover that a lease is the association of these three entities in an m:m relationship.

*A revised aircraft-airline-agent data model*

![](Figures/Chapter%207/airline%20revised.png){width="75%"}
...
![](Figures/Chapter%207/planning%20revised.png){width="75%"}
...
![](Figures/Chapter%207/nation-stock-modal.png){width="50%"}
...
![](Figures/Chapter%207/m-and-m-modality.png){width="75%"}
...
![](Figures/Chapter%207/1-and-1-modality.png){width="50%"}
...
![](Figures/Chapter%207/region-city.png){width="50%"}
...
![](Figures/Chapter%207/generalizationanimal.png){width="40%"}
...
![](Figures/Chapter%207/aggregate.png){width="75%"}
...
![](Figures/Chapter%207/sharedaggregate.png){width="75%"}
...
![](Figures/Chapter%207/compaggregate.png){width="75%"}
...
![](Figures/Chapter%207/art%20collection.png){width="75%"}

*The shrunken data model*

![](Figures/Chapter%207/art%20collection%20revised.png){width="20%"}
...
![](Figures/Chapter%206/recursive-1-and-1.png){width="30%"}
...
![](Figures/Chapter%207/address-multiple.png){width="50%"}
...
![](Figures/Chapter%207/single%20instance%20(firm).png){width="50%"}
...
Consider the problems that can occur with the identifier that records both the color and the material of an article. Chipboard with a beech wood veneer is coded BW. A black product, on the other hand, is coded BL. Problems arise whenever there is an overlap between these characteristics. What happens with a product that is finished with a black veneer on beech wood? Should the code be BW or BL? What about a black-painted product that is made out of beech wood? Maybe a new code, BB for black beech wood, is required. There will always be employees and customers who do not know the meaning of these not-so-meaningful identifiers and attribute the wrong meaning to them.
...
|                                                                                                                                                                                                                                                                                                                                   |
| VINs are normally located in several locations on a car, but the most common places are in the door frame of the front doors, on the engine itself, around the steering wheel, or on the dash near the window.                                                                                                                    |
|                                                                                                                                                                                                                                                                                                                                   |
| What do you think of the VIN as a method of vehicle identification? How do you reconcile it with the recommendation to use meaningless identifiers? If you were consulted on a new VIN system, what would advise?                                                                                                                 |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
12. Draw a data model for the following freight table taken from a mail order catalog. All values are in USD.
