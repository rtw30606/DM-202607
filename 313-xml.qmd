...
``` {.xml style="background-color:AliceBlue"}
...
![](Figures/Chapter%2018/CD.png){width="75%"}
...
The schema for the CD library follows. For convenience of exposition, the source code lines have been numbered, but these numbers are not part of a schema.[^313-xml-2]

[^313-xml-2]: You should use an XML editor for creating XML files. I have not found a good open source product. Among the commercial products, my preference is for [Oxygen](http://www.oxygenxml.com/), which you can get for a 30 days trial.
...
-   All XML documents begin with an XML declaration {1}.[^313-xml-3] The encoding attribute (i.e., encoding="UTF-8") specifies what form of Unicode is used (in this case the 8-bit form).

-   The XSD Schema namespace[^313-xml-4] is declared {2}.
...
[^313-xml-3]: In this chapter, numbers in {} refer to line numbers in the corresponding XML code.

[^313-xml-4]: A namespace is a collection of valid names of attributes, types, and elements for a schema. Think of a namespace as a dictionary.
...
![](Figures/Chapter%2018/xmlvisual.png){width="100%"}
...
> ❓ *Skill builder*
>
> 1.  Use the Chrome browser to access this book's Web site [XML page](https://www.richardtwatson.com/open/Reader/xml.html), and click on customerpayments.xml. You\
>     will see how this browser displays XML. Investigate what happens when you click on the grey triangles next to some entries.
>
> 2.  Again, using Chrome, save the displayed XML code (Save Page As ...) as customerpayments.xml, and open it in a text editor.
>
> 3.  Now, add details of the customer and payment data displayed in the following table to the beginning of the XML file. Open the saved file with Chrome, and verify your work.
...
![](Figures/Chapter%2013/cd-library-stylesheets.png){width="40%"}
...
> ❓ *Skill builder*
>
> 1.  Use the Chrome browser to access this book's Web site, navigate to the [XML page](https://www.richardtwatson.com/open/Reader/xml.html), and download cdlib.xml and cdlib.xsl to a directory or folder on your machine. Use Save Page As ... for downloading.
>
...
>
> 3.  Save the edited file in the same directory or folder as cdlib.xsl. Open the saved XML file with Chrome.
...
``` {.xml style="background-color:AliceBlue"}
doc("http://www.richardtwatson.com/xml/cdlib.xml")
  /cdlibrary/cd/cdtitle
<?xml version="1.0" encoding="UTF-8"?>
<cdtitle>Pyramid</cdtitle>
<cdtitle>Ella Fitzgerald</cdtitle>
```
...
``` {.xml style="background-color:AliceBlue"}
doc("http://www.richardtwatson.com/xml/cdlib.xml")
  /cdlibrary/cd[cdlabel='Verve']/cdtitle
<?xml version="1.0" encoding="UTF-8"?>
<cdtitle>Ella Fitzgerald</cdtitle>
```
...
``` {.xml style="background-color:AliceBlue"}
for $x in doc("http://www.richardtwatson.com/xml/cdlib.xml")
 /cdlibrary/cd/track
...
5.  Using the portion of ClassicModels that has been converted to [XML](http://www.richardtwatson.com/xml/customerpayments.xml), answer the following questions using XPath.
