...
architectures, SQL and Java, and data integrity.
...
the prior edition to [Bookdown](https://bookdown.org) format. This edition was created using [Quarto](https://quarto.org).
